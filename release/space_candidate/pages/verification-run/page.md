...
---
<!-- trackio-cell
{"type": "code", "id": "cell_4a28dec2c10f", "created_at": "2026-07-21T15:14:46+00:00", "title": "verify all claims", "command": [".venv/bin/python", "repro/src/verify_lion.py"], "exit_code": 0, "duration_s": 0.436}
-->
````bash
$ .venv/bin/python repro/src/verify_lion.py
````

exit 0 · 0.4s


````python title=verify_lion.py
...
==============================================================================
CLAIM 1 (Theorem 1): centralized Lion O(d^{1/2} T^{-1/4})
==============================================================================
  gap vs T: [np.float64(11.3659), np.float64(0.122), np.float64(0.1407)]; gap*T^0.25/d^0.5: [np.float64(13.5165), np.float64(0.2051), np.float64(0.3346)]
